...
export const metadata: Metadata = {
  title: "8 Lakes Tours — Nomadic Horse Trek Mongolia",
  description: "A 9-day immersive journey into nomadic Mongolian life. Ride on horseback through the Eight Lakes region, hosted by a local family.",
};
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mosaic { padding: 0; display: grid; grid-template-columns: 2fr 1fr 1fr; grid-template-rows: 350px 350px; gap: 3px; }
      ...
      <div className="mosaic">
        ...
        <div className="mosaic-item"><img src="/images/gers2.jpg" alt="Gers against mountain backdrop" loading="lazy" /></div>
        <div className="mosaic-item"><img src="/images/landscape2.jpg" alt="Rolling Mongolian hills" loading="lazy" /></div>
      ...
      <section className="included">
        ...
        <div className="reveal reveal-delay-1">
          ...
          <ul className="included-list not">
            ...
            <li><span className="icon">✕</span> Travel insurance (required)</li>
            <li><span className="icon">✕</span> Camping gear & sleeping bag</li>
            <li><span className="icon">✕</span> Personal snacks & trail food</li>
            <li><span className="icon">✕</span> Personal riding gear (recommended)</li>
      ...
      <section className="booking" id="book">
        ...
        <div className="reveal reveal-delay-1">
          ...
          <form className="booking-form" onSubmit={(e) => { e.preventDefault(); const btn = e.currentTarget.querySelector('.submit-btn') as HTMLButtonElement; btn.textContent = '✓ Request Received — We\'ll be in touch soon'; btn.disabled = true; }}>
            ...
            <button type="submit" className="submit-btn">Reserve My Spot →</button>
            <p style={{fontSize:'0.72rem', color:'var(--mist)', opacity:0.5, textAlign:'center', lineHeight:1.6}}>Submitting this form does not guarantee a spot. We&apos;ll be in touch within 48 hours.</p>
          </form>
        </div>
      </section>
