...
export const TOUR_DATES = [
  ...
  { date: '2026 Private Group Date', detail: 'Custom departure · Available through November 2026', status: 'On Request', muted: true, availableUntil: '2026-11-30', requiresConfirmation: true },
