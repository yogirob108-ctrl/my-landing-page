...
export const TOUR_DATES = [
  ...
  { date: 'September 14 – 22, 2026', startDate: '2026-09-14', endDate: '2026-09-22', detail: '9 Days · 8 Nights · Orkhon Valley, Mongolia', status: 'Availability by request', requiresConfirmation: true },
