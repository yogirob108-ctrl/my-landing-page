...
const FAQ_ITEMS = [
  ...
  ['How much does the trip cost?', 'The 2026 rate depends on group size: $1,999 per person for 1–2 guests, $1,949 for 3–4, $1,899 for 5–6, and $1,799 for 7–8. Group rates apply when guests book together for the same departure.'],
  ...
  ['Is the $999 online payment a deposit?', 'No. It is best understood as the online booking payment that confirms your place and covers the online booking portion. The separate family portion is paid locally in cash to the host family and varies slightly by group size.'],
