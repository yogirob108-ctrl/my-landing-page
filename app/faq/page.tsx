...
const FAQ_ITEMS = [
  ...
  ['Is the online payment a deposit?', 'No. It is best understood as the online booking payment that confirms your place. It is $999 per guest for 1–2 guests, and $974, $949, or $899 per guest for larger groups, because the group discount is shared evenly between 8 Lakes Tours and the host family. For groups of 3–8, Rob emails one personal invoice covering the whole group. The separate family portion is paid locally in clean USD cash to the host family and also varies by group size.'],
  ['What happens after I submit the booking form?', 'For bookings of 1–2 guests on a fixed date, you can continue straight to the online payment and receive confirmation once payment is complete. For groups of 3–8, Rob emails one personal invoice covering every guest so the group can pay in a single step. For 2027 and private-date requests, Rob confirms availability first and then sends the correct payment link or custom order. Before arrival, Rob or the tour operator coordinates timing with you and the host-family pickup from Bat-Ulzii.'],
