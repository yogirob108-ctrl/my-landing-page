...
export default function Page() {
  const jsonLd = {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Is the $959 online payment a deposit?', acceptedAnswer: { '@type': 'Answer', text: 'No. It is best understood as the online booking payment that confirms your place and covers the online booking portion. The separate $1,200 family portion is paid locally in cash to the host family.' } },
    ...
    <main style={pageStyle}>
      ...
      <div style={wrapperStyle}>
        ...
        {[
          ...
          ['Is the $959 online payment a deposit?', 'No. It is best understood as the online booking payment that confirms your place and covers the online booking portion. The separate $1,200 family portion is paid locally in cash to the host family.'],
          ['What happens after I pay online?', 'You receive confirmation and practical preparation notes by email. Before arrival, Rob or the tour operator coordinates timing with you; once your bus to Bat-Ulzii is booked by you or your hotel, you contact the operator on WhatsApp and the host family pickup is arranged from Bat-Ulzii.'],
