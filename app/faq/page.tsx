...
const FAQ_ITEMS = [
  ...
  ['How much does the trip cost?', 'The current 2026 rate is $1,999 USD per person. This is split into a $999 online booking payment and a $1,000 local cash payment made directly to the nomadic host family in Mongolia.'],
  ...
  ['Why is $1,000 paid in cash locally?', 'Many of the nomadic families we work with cannot reliably receive online payments or bank transfers. Paying the $1,000 family portion directly in cash ensures that money reaches the hosts transparently.'],
  ['Is the $999 online payment a deposit?', 'No. It is best understood as the online booking payment that confirms your place and covers the online booking portion. The separate $1,000 family portion is paid locally in cash to the host family.'],
  ['What happens after I pay online?', 'You receive confirmation and practical preparation notes by email. Before arrival, Rob or the tour operator coordinates timing with you and the host-family pickup from Bat-Ulzii.'],
