    ...
    <main style={pageStyle}>
      ...
      <div style={wrapperStyle}>
        ...
        {[
          ...
          ['Are there Western toilets in the countryside?', 'No. Once you leave the city, countryside toilet facilities are simple. Expect outhouses with squat toilets rather than Western flush toilets. The cabins and ger stays can still be warm, welcoming, and comfortable in a rural way, but bathroom facilities are basic. Bring toilet paper, wet wipes, hand sanitiser, and a flexible mindset.'],
