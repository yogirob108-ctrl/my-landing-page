...
const PACKING_LIST = [
  ...
  'Wet wipes, dry tissues, toilet paper and hand sanitiser for countryside outhouse toilets',
    ...
    '@graph': [
      ...
      },
      {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Are there Western toilets in the countryside?', acceptedAnswer: { '@type': 'Answer', text: 'No. Once guests leave the city, countryside toilet facilities are simple. Expect outhouses with squat toilets rather than Western flush toilets. Cabins and ger stays can be warm and welcoming, but bathroom facilities are basic, so guests should bring toilet paper, wet wipes, hand sanitiser, and a flexible mindset.' } },
      ...
      <section className="faq-section">
        <div style={{maxWidth:'760px', margin:'0 auto'}}>
          ...
          {[
            ...
            {q:'Are there Western toilets in the countryside?', a:'No — once you leave the city, countryside toilet facilities are simple. Expect outhouses with squat toilets rather than Western flush toilets. The cabins and ger stays can be warm and welcoming, but bathroom facilities are basic, so bring toilet paper, wet wipes, hand sanitiser, and a flexible mindset.'},
