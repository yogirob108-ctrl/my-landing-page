    ...
    <>
      ...
      <section className="intro" id="experience">
        ...
        <div className="reveal reveal-delay-1">
          ...
          <p className="section-body" style={{marginTop:'1.2rem'}}>That means some flexibility is part of the experience. Weather, horses, roads, and group rhythm can shape the day. You may be invited to step outside your comfort zone, but you are never forced to do every challenge — saying no, resting, or taking a quieter day around nomadic life is always allowed.</p>
