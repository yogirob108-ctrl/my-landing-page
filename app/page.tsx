  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        '@type': 'FAQPage',
        mainEntity: [
          { '@type': 'Question', name: 'Who organises the trip?', acceptedAnswer: { '@type': 'Answer', text: '8 Lakes Tours is organised by Robert Zaher through a direct relationship with Ganbold’s family in the Orkhon Valley. Online bookings, preparation, and payment communication are handled by 8 Lakes Tours, while the local family portion goes directly to your hosts in Mongolia.' } },
