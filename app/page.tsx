    ...
    <>
      ...
      <section className="intro" id="experience">
        ...
        <div className="reveal reveal-delay-1">
          ...
          <p className="section-body" style={{marginTop:'1.2rem'}}>Remote does not mean abandoned. The steppe is full of living hospitality: neighbouring families, shared tea and food, people helping each other with animals, work, supplies, and daily life across the land.</p>
