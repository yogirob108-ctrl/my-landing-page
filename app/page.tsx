      ...
      <section style={{background:'var(--ink)', padding:'7rem 2rem'}}>
        <div style={{maxWidth:'760px', margin:'0 auto'}}>
          ...
          {[
            ...
            {q:"What&apos;s the weather like in the summer?", a:'Expect warm days between 60–75°F and cool nights. Pack layers — mornings and evenings on the steppe can get cold.'},
