    ...
    <main style={pageStyle}>
      ...
      <div style={wrapperStyle}>
        ...
        {[
          ...
          ['Food and dietary reality', 'Food is part of the nomadic-family experience, not a separate restaurant service. Traditional Mongolian meals are usually built around meat, dairy, milk tea, yoghurt, cheese, and other animal products. Vegetarian guests may be possible with advance notice, but strict vegan diets and serious dairy or lactose intolerance are difficult to support in this remote setting. If food restrictions are a major health or ethical requirement for you, please speak to us before booking — this may not be the right tour.'],
          ...
          ['Remote, but not abandoned', 'The steppe can feel vast and far from city life, but it is not empty. Mongolian nomadic culture is deeply hospitable: neighbouring families know each other, people visit, share food and tea, help with work, and move through the land together. You are unlikely to be far from human kindness, basic supplies, or someone who knows the valley. Part of the beauty of the trip is seeing a culture where separate homes still belong to one living landscape.'],
        ].map(([title, body]) => (
